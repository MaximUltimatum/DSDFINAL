...
HD_PWD='/home/veymax/MASTER_PROJECT/MASTER_PROJECT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pmod_step_interface.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pmod_step_interface.tcl
