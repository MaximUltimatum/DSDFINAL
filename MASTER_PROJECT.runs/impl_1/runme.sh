...
HD_PWD='/home/veymax/MASTER_PROJECT/MASTER_PROJECT.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pmod_step_interface.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pmod_step_interface.tcl -notrace
