...
##Pmod Header JB
        #Sch name = JB1
        set_property PACKAGE_PIN A14 [get_ports {limit_switch[0]}]                    
            set_property IOSTANDARD LVCMOS33 [get_ports {limit_switch[0]}]
        #Sch name = JB2
        set_property PACKAGE_PIN A16 [get_ports {limit_switch[1]}]                    
            set_property IOSTANDARD LVCMOS33 [get_ports {limit_switch[1]}]
        ##Sch name = JB3
